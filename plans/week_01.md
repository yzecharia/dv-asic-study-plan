...
## Checklist
- [ ] Read Spear ch.1, ch.2, ch.5
- [ ] Read Spear ch.8 §§ 8.1–8.5 (inheritance, super, virtual, constructors, copying)
- [ ] Watched the 6 Verification Academy OOP lessons (Intro → Polymorphism)
- [ ] Read ChipVerify class/inheritance/polymorphism pages
- [ ] Completed HW1 (Packet class)
- [ ] Completed HW2 (Transaction hierarchy)
- [ ] Completed HW3 (Deep vs shallow copy)
- [ ] Completed HW4 (Virtual methods)
