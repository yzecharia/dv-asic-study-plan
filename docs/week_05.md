...
### Verification Track
- [ ] Read Salemi ch.15 (analysis ports, dice example)
...
- [ ] (fill in from canonical `docs/week_05.md`)
...
- [ ] **AI productivity task** — Type 5 — Waveform / debug summary (TLM analysis-port broadcast trace)
