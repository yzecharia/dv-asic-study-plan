...
- [x] Watched Verification Academy coverage + SVA modules
...
*Auto-mirrored from `week_03_coverage_assertions/` — edit those files, then run `python3 tools/sync_week_docs.py` to refresh this section.*
...
# Week 3 — Learning Assignment

## Reading

The canonical reading list with chapter and page references lives at
[`docs/week_03.md`](../docs/week_03.md). When you start
...
**Type 3 — RTL style review (your W3 traffic-light FSM)**
...
Resume bullet — Phase 1 retrospective entry
...
- [ ] (fill in from canonical `docs/week_03.md`)
...
- [ ] **AI productivity task** — Type 3 — RTL style review (your W3 traffic-light FSM)
- [ ] **Power-skill task** — Resume bullet — Phase 1 retrospective entry
