...
*Auto-mirrored from `week_07_uvm_full_testbench/` — edit those files, then run `python3 tools/sync_week_docs.py` to refresh this section.*
...
# Week 7 — Learning Assignment

## Reading

The canonical reading list with chapter and page references lives at
[`docs/week_07.md`](../docs/week_07.md). When you start
...
**Type 3 — RTL style review (your async FIFO RTL)**
...
Resume bullet — UVM env with scoreboard for register file
...
- [ ] (fill in from canonical `docs/week_07.md`)
...
- [ ] **AI productivity task** — Type 3 — RTL style review (your async FIFO RTL)
- [ ] **Power-skill task** — Resume bullet — UVM env with scoreboard for register file
