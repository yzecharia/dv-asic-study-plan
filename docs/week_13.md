...
*Auto-mirrored from `week_13_riscv_fifo_projects/` — edit those files, then run `python3 tools/sync_week_docs.py` to refresh this section.*
...
# Week 13 — Learning Assignment

## Reading

The canonical reading list with chapter and page references lives at
[`docs/week_13.md`](../docs/week_13.md). When you start
...
**Type 4 — Interview Qs (walk-through of FIFO + CPU project)**
...
Resume bullets for both portfolio repos (FIFO-UVM, RISC-V CPU)
...
- [ ] (fill in from canonical `docs/week_13.md`)
...
- [ ] **AI productivity task** — Type 4 — Interview Qs (walk-through of FIFO + CPU project)
- [ ] **Power-skill task** — Resume bullets for both portfolio repos (FIFO-UVM, RISC-V CPU)
