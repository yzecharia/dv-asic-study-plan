...
*Auto-mirrored from `week_02_constrained_random/` — edit those files, then run `python3 tools/sync_week_docs.py` to refresh this section.*
...
# Week 2 — Learning Assignment

## Reading

The canonical reading list with chapter and page references lives at
[`docs/week_02.md`](../docs/week_02.md). When you start
...
**Type 2 — Flashcards (CRV operators: solve…before, dist, randc, etc.)**
...
LinkedIn headline iterate — try Pattern B; note view-count change
...
- [ ] (fill in from canonical `docs/week_02.md`)
...
- [ ] **AI productivity task** — Type 2 — Flashcards (CRV operators: solve…before, dist, randc, etc.)
- [ ] **Power-skill task** — LinkedIn headline iterate — try Pattern B; note view-count change
