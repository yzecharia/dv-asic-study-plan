...
*Auto-mirrored from `week_06_uvm_stimulus/` — edit those files, then run `python3 tools/sync_week_docs.py` to refresh this section.*
...
# Week 6 — Learning Assignment

## Reading

The canonical reading list with chapter and page references lives at
[`docs/week_06.md`](../docs/week_06.md). When you start
...
**Type 1 — Verify (UVM sequence vs sequencer explanation)**
...
Elevator pitch — first 30s draft for the UVM agent built this week
...
- [ ] (fill in from canonical `docs/week_06.md`)
...
- [ ] **AI productivity task** — Type 1 — Verify (UVM sequence vs sequencer explanation)
- [ ] **Power-skill task** — Elevator pitch — first 30s draft for the UVM agent built this week
