# AGENTS.md — Operating Rules for `study_plan_2.0`
...
`/Users/yuval/.Codex/projects/-Users-yuval-sv-projects-study-plan-2-0/memory/`.
...
Do not duplicate facts that live in this `AGENTS.md` or in `docs/`.
